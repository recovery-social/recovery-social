...
@Component({
  selector: 'app-recover-recovery-service-success',
  templateUrl: './recover-recovery-service-success.component.html',
  styleUrls: ['./recover-recovery-service-success.component.scss']
})
export class RecoverRecoveryServiceSuccessComponent implements OnInit {
