...
@Component({
  selector: 'app-social-recovery-service-success',
  templateUrl: './social-recovery-service-success.component.html',
  styleUrls: ['./social-recovery-service-success.component.scss']
})
export class SocialRecoveryRecoveryServiceSuccessComponent implements OnInit {
